<section class="section" data-section-name="footer">
          <footer>
...
<i id="go-to-top" class="fa totop fa-chevron-circle-up animated bounce nextSlideDown"></i>
    ...
    $(function() {
      ...
      if(/puertas_de_garaje/.test(loc)) {
        $('<div class="col-md-3 product"> <article><div class="view view-more"><div class="imghover"> <img src="http://www.merik.com/img/Clopay-logo.png" class="img-responsive" alt=""> <div class="titulo"></div>  </div>  <div class="contenidoHover hidden-xs byclopay"> <h2>Merik by Clopay</h2> <br><p>Seguridad, diseño, elegancia y confiabilidad en puertas automáticas con Merik y Clopay.</p> <p><a class="info" href="<?php echo $url_base ?>alianzas">Leer más</a><div class="botones">  <ul><li class="compartir"><a href="#"><i class="fa fa-share"></i></a></li><li class="comprar"><a href="distribuidores/"><i class="fa fa-usd"></i></a></li><li class="folleto"><a href="" target="_blank"><i class="fa fa-file-pdf-o"></i></a></li> </ul> </div>  </div>  </div>  </article>  </div>').insertAfter('.breadcrumbs');
      }
    });
    </script>    
    ...
    <script type="text/javascript"> 
      $(function() {
        ...
        <script>
          ...
          ga('create', 'UA-76037805-1', 'auto'); ga('send', 'pageview');
        </script>
<?php 
if(isset($maps))
{
...
<script type="text/javascript">
  ...
  if($maps=="distribuidores" || $maps == "distribuidor")
  {
    ...
    foreach ($coordenadas as $coordenadas_array) {
     ...
     echo "['<div class=Dammap style=\"width:325px\";><div class=DamLogo><img src=".$logo_dam." width=80px height=80px border=0></div><div class=Damdatos><div class=DamEmpresa>".$coordenadas_array['Nombre_Empresa']."</div><div class=DamZona>".$coordenadas_array['Zona_']."</div><div class=DamContacto>".$ida."<a href=".$url_base."contacto/".$coordenadas_array['Id_Distribuidor'].$cadena_producto_distribuidor." style=color:#666;>Quiero contactarlo >></a></div></div></div>',".$coordenadas_array['Coordenadas_Lat'].", ".$coordenadas_array['Coordenadas_Lon'].",'".base_url()."img/punto_sucursal.png', ".$coordenadas_array['Sucursal'].", '".$coordenadas_array['Especialidad']."'],\n";
   }
  ?>
    ];
