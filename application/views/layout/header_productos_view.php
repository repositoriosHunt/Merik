...
<html class="no-js" lang="">
    <head>
        ...
        <?php
        if (false !== strpos($_SERVER['REQUEST_URI'], 'productos/residencial')) {
          echo "<script type='text/javascript'>var ssaUrl = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'pixel.sitescout.com/iap/ca6e2b49a73bd111';new Image().src = ssaUrl;</script>";
        }
        if (false !== strpos($_SERVER['REQUEST_URI'], 'productos/industrial')) {
          echo "<script type='text/javascript'>var ssaUrl = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'pixel.sitescout.com/iap/5c6fb230e00c38be';new Image().src = ssaUrl;</script>";
        }
        if (false !== strpos($_SERVER['REQUEST_URI'], 'productos/autotransporte')) {
          echo "<script type='text/javascript'>var ssaUrl = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'pixel.sitescout.com/iap/1c89a6df8681a8a5';new Image().src = ssaUrl;</script>";
        }
        ?>
    </head>
    <body class="productos <?php echo strtoupper($sub_menu['Menu_Sub']);?>">
      <header>
            <div class="container">
              <div class="col-sm-4">
              ...
              <div class="col-sm-4 logo hidden-xs">
                <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>img/logoBlco.jpg" alt="Merik"></a>
              </div>
              <div class="col-sm-4 search">
                <form action="<?php echo $url_base; ?>buscador" method="post" name="buscador" id="buscador" ><input type="hidden" id="url_buscar" value="<?php echo $url_base."buscador";?>"><input type="text" name="campo_buscar" id="campo_buscar" class="" placeholder="Palabra a buscar" /> <i class="fa fa-search" id="boton_buscar"></i></form>
              </div>
            </div>
          </header>
