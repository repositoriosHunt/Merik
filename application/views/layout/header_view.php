...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>css/component-slider.css">
        <!-- Facebook Pixel Code -->
        <script>
        ...
        <noscript>
            <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/styleNoJS.css" />
        </noscript>


        <script src="<?php echo base_url(); ?>js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
        <script type="text/javascript">var ssaUrl = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'pixel.sitescout.com/iap/44b69529cae5160b';new Image().src = ssaUrl;</script>
    </head>
    <body class="home">