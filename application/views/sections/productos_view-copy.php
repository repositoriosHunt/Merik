          ...
          <article>
            <div class="view view-more">  
              ...
              <div class="visible-xs">
               ...
               <div class="producto">
                  <a href="<?php echo base_url(); ?>producto/detalle/<?php echo $productos_array['Id_Producto']; ?>" class="venobox info" data-gall="productos2" data-type="ajax"><i class="fa fa-plus-circle"></i> Leer más</a>
               </div>
            <div class="botones">
                  <ul>
                   <li class="compartir"><a href="#"><i class="fa fa-share"></i></a></li>
       ...
       <section class="scroll complementos" data-section-name="complementos">
        <div class="container">
          ...
          foreach ($complementos  as $complementos_array) {
            ...
            <div class="link">
              <a href="'.base_url().'producto/detalle/'.$complementos_array['Id_Producto'].'" class="venobox info" data-gall="productos2" data-type="ajax">'.$complementos_array['Producto'].'<a>
