<body class="landing">
        ...
        <header class="landingPage">
            <div class="slider">
            	<div class="title">Para entrar rápido y seguro a tu hogar,<br> nada mejor que una puerta automática MERIK</div>
      ...
      <div class="centerLP"><h1 class="bloquesLP sin"><span class="icon-home"></span> Conoce más sobre el automatismo</h1></div>
  <div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> Sólo los expertos sabemos abrir las puertas a la comodidad. ¡Contáctanos!</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="confiaenlosexpertos">
