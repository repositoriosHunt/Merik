<body class="landing">
	...
	<h1 class="h1">Contáctanos y uno de nuestros expertos<br>te abrirá las puertas a la comodidad</h1>
  ...
  <div id="dam_seleccionado_nombre"></div>
  <div id="dam_seleccionado_zona"></div>
