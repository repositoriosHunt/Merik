<body class="landing">
        ...
        <header class="landingPage">
            <div class="slider">
            	<div class="title">Para que ni tú ni los tuyos se tengan que bajar del auto, <br> nada mejor que una puerta automática MERIK</div>
      ...
      <div class="centerLP"><h1 class="bloquesLP sin"><span class="icon-home"></span> Sigue el camino al automatismo sin bajarte del coche</h1></div>
	<div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> Seguridad y comodidad para ti. ¡Contáctanos!</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="safoabrir">
