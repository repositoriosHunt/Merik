<body class="landing">
        ...
        <header class="landingPage">
            <div class="slider">
            	<div class="title">Olvídate de las complicaciones para abrir al llegar,<br> nada mejor que una puerta automática MERIK</div>
      ...
      <div class="centerLP"><h1 class="bloquesLP sin"><span class="icon-home"></span> ¡Garantiza tu entrada!. Empieza con un clic aquí</h1></div>
  <div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> Garantiza tu entrada y contacta a nuestros expertos</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="garantizatuentrada">
