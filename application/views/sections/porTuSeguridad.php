<body class="landing">
        ...
        <header class="landingPage">
            <div class="slider">
            	<div class="title">Sabemos que proteger a los tuyos es una prioridad,<br> por eso nada mejor que una puerta automática MERIK</div>
     ...
     <section class="section distribuidoresLP" data-section-name="distribuidores">
      <div class="centerLP"><h1 class="bloquesLP sin"><span class="icon-home"></span> Nuestro sitio, también abre en automático</h1></div>
  <div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> ¡Contacta a nuestros expertos! Ellos te darán la solución para mantener a tu familia segura y cómoda</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="portuseguridad">
