<body class="landing">
        ...
        <header class="landingPage">
            <div class="slider">
            	<div class="title">Olvídate de correr para llegar antes que la lluvia,<br> por eso nada mejor que una puerta automática MERIK</div>
      ...
      <div class="centerLP"><h1 class="bloquesLP sin"><span class="icon-home"></span> Corre a nuestra página antes que la lluvia</h1></div>
  <div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> Por si las lluvias, tenemos las puertas a la comodidad. ¡Contáctanos!</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="porsilaslluvias">
