...
<section class=" section" data-section-name="sucursales">
	<h1 class="h1">Sucursales</h1>
	<p class="text-center">El control de las ventas lo decides tú, <strong>conoce las diferentes sucursales que tenemos</strong><br>y sé parte de nuestros distribuidores. Pregunta por los requisitos.</p>
	...
	<div class="container buscaDistribuidor">
		...
		<div class="col-md-12">
			<!-- <div id="map_canvas" class="mapa" style="width: 100%; height: 500px;"></div> -->
			<button class="ubicacion col-sm-2 col-xs-12" onClick="localizar()">Mi Ubicación</button>
			<input id="searchTextField" type="text" class="col-xs-12 col-sm-10">
			<span class="recomendacion col-xs-12 col-sm-10 col-sm-offset-2">Recomendación de búsqueda: (Colonia, Municipio)</span>
