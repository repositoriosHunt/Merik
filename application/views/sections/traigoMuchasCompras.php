<body class="landing">
      ...
      <div class="centerLP"><h1 class="bloquesLP sin"><a href="http://www.merik.com"><span class="icon-home"></span></a> <a href="http://www.merik.com">ABRE LA PUERTA AL AUTOMATISMO ¡VISITA NUESTRA PÁGINA!</a></h1></div>
  <div class="centerLP"><h1 class="bloquesLP"><span class="icon-mail"></span> Contáctanos y evita que el frío entre.  Los expertos te abrimos las puertas.</h1></div>
...
<div class="form-group">
  ...
  <input type="hidden" id="tipo_landing" value="traigomuchascompras">
...
<div class="centerLP"><h1 class="bloquesLP"><span class="icon-mexico"></span> ENCUENTRA TU DISTRIBUIDOR EN AUTOMÁTICO. ESTAMOS EN TODA LA REPÚBLICA MEXICANA</h1></div>
