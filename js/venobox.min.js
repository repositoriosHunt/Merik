...
(function($){
          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    core = '<div class="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="o-content"><div class="vbox-content"></div></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-next"><i class="fa fa-chevron-right"></i></div><div class="vbox-prev"><i class="fa fa-chevron-left"></i></div></div>';
    ...
    function loadAjax(){
      ...
      cache: false
          ...
          content.html('<div class="vbox-inline">'+ msg +'</div>'+'<div class="vbox-close">X</div>');
          updateoverlay(true);

      }).fail(function() {
          content.html('<div class="vbox-inline"><p>Error retrieving contents, please retry</div>'+'<div class="vbox-close">X</div>');
          updateoverlay(true);
      })
    }
    ...
    /* -------- LOAD INLINE -------- */
    function loadInline(){
      content.html('<div class="vbox-inline">'+$(dest).html()+'</div>'+'<div class="vbox-close">X</div>');
      updateoverlay();
    }
